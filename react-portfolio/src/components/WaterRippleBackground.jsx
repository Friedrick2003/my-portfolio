...
const WaterRippleBackground = () => {
  ...
  useEffect(() => {
    ...
    causticCanvas.style.opacity = '0.55';
    ...
    rippleCanvas.style.opacity = '0.5';
    ...
    const drawBackground = () => {
        ...
        const bottomGrad = bgCtx.createLinearGradient(0, h * 0.72, 0, h);
